...
export default {
    ...
    validations: {
        input: {
            ...
            nik: {required: requiredUnless('isPeserta'), minLength: minLength(10), maxLength: maxLength(18)},
            dob: {required: requiredUnless('isPeserta')},
            ...
            contact: {required: requiredUnless('isPeserta')},
            age: {required: requiredUnless('isPeserta')},
            vacCenter: {required: requiredUnless('isPeserta')},
    ...
    methods: {
        ...
        onSubmit() {
            ...
            if(this.$route.name == 'editProfile') {
                ...
                this.$http.post(`${this.api}participant/profile/${this.user.id}`, formData, {
                    headers: {
                        'Authorization': `Bearer ${this.token}`
                    }
                }).then((response) => {
                ...
                this.$http.post(`${this.api}signup/participant/general`, formData, {
                    headers: {
                        'Authorization': `Bearer ${this.token}`
                    }
                }).then((response) => {
